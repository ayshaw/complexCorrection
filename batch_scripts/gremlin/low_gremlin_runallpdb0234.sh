...
#SBATCH -o output_logs/gen_%j_allpdb0234_.out
#SBATCH -e output_logs/gen_%j_allpdb0234_.err
module load gcc/6.2.0 python/3.6.0 cuda/9.0
source activate evcouplings_stable
source ~/jupytervenv/bin/activate
python /home/as974/ada/multimerCorrection/GREMLIN_TF_v2_weights_edit.py allpdb0234